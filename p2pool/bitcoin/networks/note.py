...
SYMBOL = 'NTBC'
CONF_FILE_FUNC = lambda: os.path.join(os.path.join(os.environ['APPDATA'], 'Notecoin') if platform.system() == 'Windows' else os.path.expanduser('~/Library/Application Support/Notecoin/') if platform.system() == 'Darwin' else os.path.expanduser('~/.notecoin'), 'notecoin.conf')
